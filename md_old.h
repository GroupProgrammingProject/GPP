...
{ double boltz=1./11603,svxm=0.0,svym=0.0,svzm=0.0,kin,Tf;
  ...
  ebs=Hamiltonian(N,modr,rx,ry,rz,c,v); //calculate new eigenvectors and band structure energy
